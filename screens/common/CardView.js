...
export default class FeedCard extends React.Component {
  ...
  renderimage() {
    if (this.props.data.type === "FL_ITEM" || this.props.data.type === "HOTEL_ITEM") {
      return (
        ...
        // }}
        >
          <Image style={styles.image} resizeMode='contain' source={{ uri: this.props.data.values.imgUrl }} />
  ...
  ///////////////////////////////////////////////////////
  rendertext() {
    if (this.props.data.type === "FL_ITEM" || this.props.data.type === "HEADER" || this.props.data.type === "HOTEL_ITEM" || this.props.data.type === "TEXT_ITEM") {
      return (
          ...
          <View>
            <Text adjustsFontSizeToFit={true}
              ...
              style={{
                ...
                color: 'black',
                fontSize: 20
              }}>{this.props.data.values.stops}</Text>
          </View>
        </TouchableWithoutFeedback>
      )
    }
    ...
    return (
      <View style={styles.root}>
        <View style={styles.topWrapper} >
          <Image source={{ uri: this.props.data.values.imgUrl }} style={styles.avatar} />
          <Text style={styles.userName}>Sujay</Text>
        </View>
        {this.rendertext()}
        {this.renderimage()}
        {this.renderFooter()}
